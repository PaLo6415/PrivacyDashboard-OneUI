...
public class CardView extends LinearLayout {
    ...
    private void init() {
        ...
        if (mIsIconView) {
            inflate(mContext, R.layout.oui_view_cardview_icon_item_layout, this);
            ...
            inflate(mContext, R.layout.oui_view_cardview_item_layout, this);
        }
        ...
        lp.setMarginStart(mIsIconView ?
                getResources().getDimensionPixelSize(R.dimen.oui_cardview_divider_margin_start_end)
                        + getResources().getDimensionPixelSize(R.dimen.oui_cardview_icon_size)
                        + getResources().getDimensionPixelSize(R.dimen.oui_cardview_icon_margin_end)
                : getResources().getDimensionPixelSize(R.dimen.oui_cardview_divider_margin_start_end));
        lp.setMarginEnd(getResources().getDimensionPixelSize(R.dimen.oui_cardview_divider_margin_start_end));
