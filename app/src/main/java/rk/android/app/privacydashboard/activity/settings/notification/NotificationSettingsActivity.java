package rk.android.app.privacydashboard.activity.settings.notification;
...
import rk.android.app.privacydashboard.fragment.settings.notification.NotificationSettingsFragment;
...
public class NotificationSettingsActivity extends AppCompatActivity {
    ...
    private void initAppBar() {
        ...
        binding.switchBarLayout.setTitle(getString(R.string.oui_settings_notification_title));
    }

    private void initSwitchBar() {
        binding.switchBarLayout.setChecked(preferenceManager.isPrivacyNotification());
        binding.switchBarLayout.addOnSwitchChangeListener((switchCompat, checked) -> {
            preferenceManager.setPrivacyNotification(checked);
